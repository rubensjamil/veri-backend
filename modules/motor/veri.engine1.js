// ============================================================
// veri.engine.js - Motor VERI (├║nico e soberano)
...
// ============================================
// FUN├ç├òES DE C├üLCULO POR FATOR
// ============================================
...
// ============================================
// FUN├ç├âO PRINCIPAL: calcularRiscos
// ============================================
...
function calcularRiscos(dados) {
    ...
    const palavrasCriticas = [
        ...
        'LIQUIDA├ç├âO', 'LIQUIDACAO', 'RECUPERA├ç├âO', 'RECUPERACAO',
        'FAL├èNCIA', 'FALENCIA', 'INTERVEN├ç├âO', 'INTERVENCAO',
        'INAPTA', 'INAPTID├âO'
    ];
    ...
    if (isCritica) {
        ...
        return {
            ...
            risco_principal: 'SITUA├ç├âO CR├ìTICA',
            riscos: riscos,
            ...
            alerta: {
                ...
                mensagem: 'A empresa est├í com situa├º├úo "' + situacaoRaw + '". Neg├│cios com essa situa├º├úo s├úo considerados invi├íveis.',
                acao_recomendada: 'N├úo prossiga com este neg├│cio.'
            }
        };
    }
